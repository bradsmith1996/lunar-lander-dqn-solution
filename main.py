...
if __name__ == '__main__':
   ...
   run = True
   n_episodes = 100
   run_model_name = '/Users/brad/School/gt/summer2021/cs7642/7642Summer2021psmith98/Project_2/studies/hidden_layers/h256/network.pth'
   seed = 1200
   # Train:
   if train:
      lander = LunarLanderAgent()
      lander.train(render=False)
      ...
      plt.show()
      #lunar_lander.demo_heuristic_lander(lander.env, render=True)
   if run:
      lander = LunarLanderAgent()
      lander.set_seed(seed)
      lander.run(run_model_name,n_episodes,render=False)
